...
// Scan image with Gemini Vision, and also apply Arcjet rate limiting logic i.e, requested, isRateLimit()
export async function scanPantryImage(formData) {
  try {
    //user logged in or not/ authentication
    ...
    const prompt = `
You are a professional chef and ingredient recognition expert. Analyze this image of a pantry/fridge and 
