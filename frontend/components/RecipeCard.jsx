...
export default function RecipeCard({ recipe, variant = "default" }) {
  ...
  if (variant === "grid") {
    return (
      <Link href={data.href}>
        <Card className="rounded-none overflow-hidden border-stone-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300
         cursor-pointer group pt-0">
          {/* Image */}
          {data.showImage ? (
            <div className="relative aspect-square">
              ...
              {/* Hover Overlay */}
              <div className="absolute inset-0 bg-linear-to-t from-black/60 via-transparent to-transparent opacity-0 
            ...
            <div className="relative aspect-square bg-gradient-to-br from-orange-400 via-amber-400 to-yellow-400 flex 
      ...
      <Card className="rounded-none border-stone-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
          ...
          <div className="relative aspect-video">
            ...
            {data.matchPercentage && (
              <div className="absolute top-4 right-4">
                <Badge
                  className={`${
                    data.matchPercentage >= 90 ? "bg-green-600" : data.matchPercentage >= 75 ? "bg-orange-600" : "bg-stone-600"
        ...
        <CardHeader>
          <div className="flex justify-between items-start">
            {/* Show the cuisin, category eg., french dinner, american snack*/}
        ...
        <CardContent className="space-y-4 flex-1">
          ...
          {(data.prepTime || data.cookTime || data.servings) && (
            <div className="flex gap-4 text-sm text-stone-500">
              ...
              {/* Show number of people to serve */}
              {data.servings && (
                <div className="flex items-center gap-1">
